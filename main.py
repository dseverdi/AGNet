...
# Reuse the exact ray-casting implementation from robotics_mapping.
_THIS_DIR = Path(__file__).resolve().parent
_ROBOTICS_MAPPING_DIR = _THIS_DIR / "robotics_mapping"
if str(_ROBOTICS_MAPPING_DIR) not in sys.path:
    sys.path.insert(0, str(_ROBOTICS_MAPPING_DIR))

from ray_casting import ray_casting, ray_casting_init  # type: ignore  # noqa: E402
from reshape import reshape_whether_intersect  # type: ignore  # noqa: E402
...
def compute_visible_cells(
    ...
    whether_intersect = reshape_whether_intersect(whether_intersect, clipped_rays.shape[0])
